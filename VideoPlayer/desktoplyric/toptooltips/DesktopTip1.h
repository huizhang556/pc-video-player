...
class DesktopTip1 : public QWidget
{
    Q_OBJECT

    explicit DesktopTip1();
public:
    ~DesktopTip1();
    //动画模式枚举
    enum AnimationMode
    ...
    //获取动画模式
    static DesktopTip1::AnimationMode getMode();

    //设置动画模式
    static void setMode(DesktopTip1::AnimationMode newMode);
