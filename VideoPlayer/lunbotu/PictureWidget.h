...
#define RAW_VIEW_SIZE QSize(800,260) //原始场景大小 620,260
#define SCALE_VIEW_PIXMAP (qreal)1/1 //承载图片的View与图片比例，此处是1:1填充（比例可以为小数）
#define SCALE_BIG_SMALL (qreal)1/1 //图片大小比例

//P1-P10，10个位置，根据需要改动
#define P1 (qreal)-0.25
#define P2 (qreal)0.06 //0.15
#define P3 (qreal)0.45 //0.44
