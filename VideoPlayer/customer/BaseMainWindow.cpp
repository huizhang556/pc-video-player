...
void BaseMainWindow::setTitleBarMoveArea(QWidget *titleBar, const int margin)
{
    if(titleBar == nullptr)
    {
        title_margin = 0;
...
void BaseMainWindow::SetMouseCursor(int x, int y)
{
...
int BaseMainWindow::GetMouseRegion(int x, int y)
{
    int w = this->width();
