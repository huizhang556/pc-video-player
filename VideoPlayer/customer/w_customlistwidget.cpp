    ...
    : SuspendedScrollBar_ListWidget(parent)
{
    ...
    QString style_file = R"(QListWidget
                         {
                             outline: 0px;
    ...
    : QWidget(parent)
{
    ...
    m_labelName->setText( u8"Qt 开发者 GS");
    ...
    m_labelContent->setText(QString(u8"ItemId==%1。Q群：287249639，本群只用于 Qt 开发者的分流，可以刷水，也可以讨论技术。").arg(giNum));
